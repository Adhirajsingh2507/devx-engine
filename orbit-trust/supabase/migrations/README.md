...
| 0002_fleet_reentry.sql | M3/M4 | candidate_sets, comparisons, operations, operation_items, economic_scenarios, reentry_scenarios, communication_packets | TODO |
| 0003_rpcs.sql | M1 | server-only transactional RPCs (create/seed workspace, import batch, save action, claim/commit operation, finalize assessment/packet, reset) | TODO |
| 0004_seed.sql | M1 | synthetic public_seed_templates (default demo seed, doc 11) | TODO |
