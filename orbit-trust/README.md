...
Full specification: `../main project/orbit_trust_handoff/` (docs 00-19). This
directory is the implementation, scoped entirely to `orbit-trust/` and built
alongside — never touching — the `3d-game/` app.
